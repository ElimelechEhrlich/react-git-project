...
function createGrid(options = {}) {
  ...
  const Grid3 = React9.forwardRef(function Grid4(inProps, ref) {
    ...
    return (0, import_jsx_runtime3.jsx)(GridRoot, {
      ...
      children: React9.Children.map(children, (child) => {
        var _a;
        if (React9.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider2(props) {
    ...
    const element = (0, import_jsx_runtime12.jsxs)(React21.Fragment, {
...
function createStack(options = {}) {
  ...
  const Stack2 = React23.forwardRef(function Grid3(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
